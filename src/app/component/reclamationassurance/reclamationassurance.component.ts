...
@Component({
  selector: 'app-reclamationassurance',
  templateUrl: './reclamationassurance.component.html',
  styleUrls: ['./reclamationassurance.component.css']
})
export class ReclamationassuranceComponent implements OnInit,OnDestroy {
