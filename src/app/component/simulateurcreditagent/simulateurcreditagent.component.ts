...
@Component({
  selector: 'app-simulateurcreditagent',
  templateUrl: './simulateurcreditagent.component.html',
  styleUrls: ['./simulateurcreditagent.component.css']
})
export class SimulateurcreditagentComponent implements OnInit,OnDestroy {
